...
public:
    ...
    virtual     void        getAudioPortConfig(struct audio_port_config *config);
				...
				/*
                *vaylb add 
                *mStreamOutHandle sort the handle for this thread.
                */
				sp<StreamOutHandle>			mStreamOutHandle;
...
private:
    ...
    uint32_t                        sleepTime;
	//add pzhao for check track ready or not
    bool 				trackready;
    volatile    bool 		needcheckwrited;
