...
/**
     * @author:audio
     * add two interface
     *time_delay_slave function for calculate time delay of slave from java audioTrack first write to hal first write
     */
     
	audio_io_handle_t vaylb_current_otput;
	virtual sp<IStreamOut> gethandle();
	virtual void closehandle();
	virtual audio_io_handle_t get_current_output();
...
/**
 *audio include head file
 */
#include "StreamOutHandle.h"
#include "Threads.h"
...
#include "PatchPanel.h"
    ...
    mutable     hardware_call_state                 mHardwareStatus;    // for dump only
				...
				//vaylb added for sort current offload threag id
				audio_io_handle_t vaylb_current_offload_thread_id;
				//audio added for get AudioStreamOutHandle from Vector mSynergyHandles
				sp<StreamOutHandle>  getThreadStreamOutHandle(audio_io_handle_t handle);
private:
